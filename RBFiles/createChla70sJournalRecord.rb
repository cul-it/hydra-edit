...
#    note = []
    ...
    #       puts "titlestmt_titletype = " + titlestmt_titletype
        ...
        # puts "titlestmt_author = " + titlestmt_author
         titlearray = titlestmt_title.to_s.split(':')
         titlestmt_title = titlearray[0]
         ...
         splitid = pubstmt_idno.to_s.split('_')
         thisid = splitid[0]
         availability = ""
...
#        col = Collection.find("corehist")
         journalpid = "chla" + thisid 
        puts " entering Journal.new for " + journalpid
        journal = Journal.new(id: journalpid, title: [titlestmt_title], compiler: [compiler], editor: [editor], 
...
lines.each do |line|
 ...
 ARGV[0] = line.chomp
 data = Parser.new("/collections/chla/7031969_8497_017/chla-s-70-7031969_8497_017-serials-WithDimsOCR-Mar15.xml")
