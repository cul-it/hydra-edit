         ...
         if vol_issue_text[1] == 'Index '
          ...
          if !vol_issue_text[1].nil?
           ...
           if !vol_issue_text[1].nil? and (vol_issue_text[1].include? "Edition Revised" or vol_issue_text[1].include?"Edition Reprint")
             issue_number_text = "1_revised"
           else
             if !vol_issue_text[1].nil? and vol_issue_text[1].include? "Index"
              issue_number_text = "1_index"
             else
              if issue_number_text == "1" or issue_number_text == ""
...
#        col = Collection.find("corehist")
  ...
  #       end
        issuepid = "chla7031969_750_1"
        puts " entering Issue.new for " + issuepid
