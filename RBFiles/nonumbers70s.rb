...
#    note = []
    ...
    #       puts "titlestmt_titletype = " + titlestmt_titletype
        ...
        if !title_split[1].nil?
         ...
         if !vol_issue_text[1].nil? and vol_issue_text[1].include? "Index"
          ...
          # issue_number_text = issue_text[1]
           ...
           if !vol_issue_text[0].nil? and (vol_issue_text[0].include? "Edition" or vol_issue_text[0].include?"Edition Reprint")
             issue_number_text = "revised" 
           else
             if !vol_issue_text[1].nil? and vol_issue_text[1].include? "Supplement"
              issue_number_text =  "supplement"
             else
              issue_number_text = ""
             end
           end
        ...
        # puts "titlestmt_author = " + titlestmt_author
         ...
         puts "HEDEDEDEDE = " + pubids.inspect
         journalpid = pubids[0]
         vol_issue_text =  "1" #pubids[2].sub!(/^[0]+/,'') 
         puts "HEDEDEDE " + vol_issue_text
         availability = ""
...
#        col = Collection.find("corehist")
         ...
         if issue_number_text.blank?
            issuepid = journalpid + "_" + vol_issue_text #+ "_" + issue_number_text 
         else
            issuepid = journalpid + "_" + vol_issue_text + "_" + issue_number_text #bulletin_text + "_" + bulletin_number_text #issue_number_text 
         end
...
inputparam = ARGV[0]
lines = File.foreach("finishup70s.txt")
lines.each do |line|
