    ...
    #       puts "titlestmt_titletype = " + titlestmt_titletype
         ...
         if !vol_issue_text[1].nil? and vol_issue_text[1].include? "Index"
          ...
          # issue_number_text = issue_text[1]
           ...
           if !vol_issue_text[1].nil? and (vol_issue_text[1].include? "Edition" or vol_issue_text[1].include?"Edition Reprint")
             issue_number_text =  series_number_text
           else
...
inputparam = ARGV[0]
lines = File.foreach("chla7031969One.txt")
lines.each do |line|
