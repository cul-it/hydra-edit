...
#            image_seq = " " 
         ...
         #   puts image_ref
          ...
          if image_seq.to_i >= 1 
          #bookid = "chla" + ARGV[0]
          pagepid = "boli" + ARGV[0] + "_" + image_seq
     ...
     #     thumbnail = "http://hydrastg.library.cornell.edu/fedora/get/" + pagepid + "/thumbnailImage"
          ...
          #  puts "swing"
           ...
           puts "FileSet ID = " +  filesetid
             ...
             fs.awsimage = ["http://s3.amazonaws.com/cul-hydra/bolivian/" + ARGV[0] + "/jpg/" + image_ref]
             fs.awsthumbnail = ["http://s3.amazonaws.com/cul-hydra/bolivian/" + ARGV[0] + "/thumbs/" + image_ref]
          else
...
#lines = File.foreach('onehuntpagesfilesets.txt')
lines = File.foreach('bolpagefilesets.txt')
