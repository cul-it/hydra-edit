     ...
     #     thumbnail = "http://hydrastg.library.cornell.edu/fedora/get/" + pagepid + "/thumbnailImage"
          ...
          #  puts "swing"
           ...
           if image_seq.to_i >= 1  
             ...
             fs.awsimage = ["http://s3.amazonaws.com/cul-hydra/new_may/" + ARGV[0] + "/jpg/" + image_ref]
             fs.awsthumbnail = ["http://s3.amazonaws.com/cul-hydra/new_may/" + ARGV[0] + "/thumbs/" + image_ref]
          else
...
lines = File.foreach('maypagesfilesetsone.txt')
