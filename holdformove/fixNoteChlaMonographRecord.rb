...
#        col = Collection.find("corehist")
        ...
        if bookpid == "chla2719672"
          puts "leaving now"
          exit
        end
        book = Book.find(bookpid)
                       #, title: [titlestmt_title], alternative_title: [alt_title], compiler: [compiler], editor: [editor], 
...
data = Parser.new("/collections/chla/chla-m-1227-monographs-WithDims-Oct13-Full.xml")
...
#data = Parser.new("/cul/data/collections/chla/chla-m-30-monographs-WithDims-Dec09.xml")
